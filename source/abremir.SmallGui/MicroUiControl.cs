...
/// <summary>
/// An Avalonia control that hosts and renders a MicroUI immediate-mode interface.
/// </summary>
public class MicroUiControl : Control
{
    ...
    public override void Render(DrawingContext context)
    {
        ...
        // This loop efficiently processes the command list generated by MicroUI.
        int cmdIdx = -1;
    ...
    protected override void OnPointerPressed(PointerPressedEventArgs e)
    {
        ...
        if (properties.IsLeftButtonPressed) btn |= MuMouse.Left;
        if (properties.IsRightButtonPressed) btn |= MuMouse.Right;
        if (properties.IsMiddleButtonPressed) btn |= MuMouse.Middle;
    ...
    protected override void OnPointerReleased(PointerReleasedEventArgs e)
    {
        ...
        var p = e.GetPosition(this);
        MuMouse btn = MuMouse.None;
        if (e.InitialPressMouseButton == MouseButton.Left) btn |= MuMouse.Left;
        if (e.InitialPressMouseButton == MouseButton.Right) btn |= MuMouse.Right;
        if (e.InitialPressMouseButton == MouseButton.Middle) btn |= MuMouse.Middle;
    ...
    private FormattedText GetFormattedText(Typeface font, string text, IBrush colour)
    {
        ...
        if (_textCache.TryGetValue((text, font), out var formattedText)) return formattedText;
    ...
    private static MuKey MapKey(Key key, KeyModifiers modifiers)
    {
        ...
        if ((modifiers & KeyModifiers.Shift) != 0) res |= MuKey.Shift;
        if ((modifiers & KeyModifiers.Control) != 0) res |= MuKey.Ctrl;
        if ((modifiers & KeyModifiers.Alt) != 0) res |= MuKey.Alt;
